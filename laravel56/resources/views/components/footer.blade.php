                ...
                <div class="col-md-3 col-sm-4">
                    <div class="single-snap-footer">
                        ...
                        <div class="cakewalk-footer-content">
                            <p class="footer-des"> Phân phối thực phẩm chức năng Organic sỉ & lẻ.</p>
                ...
                <div class="col-md-3 col-sm-4">
                    <div class="info-fcontainer">
                        ...
                        <div class="infof-content">
                            <h3>Địa chỉ</h3>
                            <p>Thị Trấn Tiên Kỳ - huyện Tiên Phước - tỉnh Quảng nam</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-4">
